...
public class AwsPaymentOutboxMessagePublisher implements OutboxMessagePublisher {
    ...
    private static final String PAYMENT_EVENTS_TOPIC = "payment-events.fifo";
    ...
    public CompletableFuture<Void> publish(OutboxMessage message) {
        try {
            ...
            return CompletableFuture.runAsync(() -> {
                ...
                snsTemplate.sendNotification(PAYMENT_EVENTS_TOPIC, SnsNotification.builder(jsonPayload)
