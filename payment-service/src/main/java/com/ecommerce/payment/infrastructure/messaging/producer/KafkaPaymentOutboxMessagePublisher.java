...
@Profile("kafka")
@Slf4j
public class KafkaPaymentOutboxMessagePublisher implements OutboxMessagePublisher {
    ...
    public KafkaPaymentOutboxMessagePublisher(KafkaTemplate<String, SpecificRecordBase> kafkaTemplate,
    ...
    public CompletableFuture<Void> publish(OutboxMessage message) {
        try {
            ...
            return kafkaTemplate.send(PAYMENT_EVENTS_TOPIC, message.getAggregateId(), avroEvent)
